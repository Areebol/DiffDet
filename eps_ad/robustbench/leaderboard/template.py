...
from eps_ad.robustbench.utils import ACC_FIELDS


def generate_leaderboard(
    dataset: Union[str, BenchmarkDataset],
    threat_model: Union[str, ThreatModel],
    models_folder: str = "model_info",
) -> str:
    ...
    result = template.render(
        ...
        dataset=dataset,
        models=models,
        acc_field=acc_field if isinstance(acc_field, str) else acc_field[-1],
    )
    print(result)
    return result
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--threat_model", type=str, help="The threat model of the desired leaderboard."
    )
    parser.add_argument(
        "--models_folder",
        type=str,
